...
This will create an executable jar file **javaops-app-bootable.jar** within the _target_ maven folder. This can be started by executing the following command
    java -jar target/javaops-app-bootable.jar -Djboss.socket.binding.port-offset=100
